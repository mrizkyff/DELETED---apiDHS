	  ...
	  <div class="carousel-inner">
	    <div class="carousel-item active">
	    	<a href="page/akun.php">
	      	<img src="assets/img/slide001.png" class="d-block w-100" alt="...">	
	    	</a>
	    </div>
	    <div class="carousel-item">
	      <img src="assets/img/slide002.png" class="d-block w-100" alt="...">
	    </div>
	    <div class="carousel-item">
	      <img src="assets/img/slide003.png" class="d-block w-100" alt="...">
	    </div>
	  </div>
    ...
    <!-- awal container -->
	  ...
	  <div class="container">
	    ...
	    <center>
	    	...
	    	<div class="row">
	    		<div class="col-sm-4">
	    			<img src="assets/img/tambah.png" width="100px" alt="">
	    		</div>
	    		<div class="col-sm-4">
	    			<img src="assets/img/special.png" width="100px" alt="">
	    		</div>
	    		<div class="col-sm-4">
	    			<img src="assets/img/kurang.png" width="100px" alt="">
	    		</div>
	    	</div>
	    	<div class="row">
	    		<div class="col-sm-4">
	  ...
	  <br><br>
	    			...
	    			foreach($menu as $data){
						...
						<div class="col-sm-4">
			    			<div class="card" style="width: 18rem; height: 600px;margin-top: 50px;">
							  <img src="assets/img/food/<?php echo $data['gambar'] ?>" class="card-img-top" alt="...">
							  <div class="card-body">
							    <p class="card-text text-dark text-left"><?php echo $data['deskripsi'] ?></p>
							    <p style="font-size: 14px;" class="text-dark text-left">
							    Kode Barang : <?php echo $data['id_produk']; ?>
							    <br>
							    Nama Barang : <?php echo $data['namaBarang']; ?>
							    <br>
							    ...
							    <a href="" class="btn btn-warning text-light" style="padding-right: 25px; padding-left: 25px;width: 100%" data-toggle="modal" data-target="#modal-<?php echo $data['id_produk'] ?>">Beli</a>
		...
		<div class="row">
			<div class="col-sm-4">
				<img src="assets/img/food/ayam.jpg" alt="" width="300px" class="rounded-circle">
			</div>
			<div class="col-sm-4">
				<img src="assets/img/food/bbq.jpg" alt="" width="300px" class="rounded-circle">
			</div>
			<div class="col-sm-4">
				<img src="assets/img/food/ikan.jpg" alt="" width="300px" class="rounded-circle">
			</div>
		</div>
		<div class="row">
			<div class="col-sm-4">
